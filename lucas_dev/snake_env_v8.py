...
class SnakeEnvV8:
    """
    Snake Game Environment V8: "Safety First"
    
    Identical to V7 in logic, but intended to be paired with an agent
    that actively uses the 'Death' state (0) as a hard constraint mask.
    
    State Representation: (8 * 81 = 648 states)
    1. Food Direction (8 values)
    2. Surroundings (4 directions * 3 levels = 81 values):
       - Calculated using the time-aware flood fill from V7.
    """
